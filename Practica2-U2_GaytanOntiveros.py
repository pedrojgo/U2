...
# Reemplaza 'nombre_del_archivo.csv' con la ruta o nombre de tu archivo CSV
df = pd.read_csv('archivo2.csv')

# Muestra las primeras filas del DataFrame para verificar si los datos se cargaron correctamente
print(df.head())
